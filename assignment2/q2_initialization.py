...
def xavier_weight_init():
    ...
    def _xavier_initializer(shape, **kwargs):
        ...
        out = tf.Variable(tf.random_uniform(shape, minval=-epsilon, maxval=epsilon)) # IMPORTANT, out MUST be a tf.Variable. Otherwise, the weight will not be trained after all
        ### END YOUR CODE
        return out
